...
# Homography (8 dof)
def hom(frame, patch_size=128, rho=32, rho_2=20, training=True, 
    ...
    #drawRegion(frame, to_homogeneous(corners), color=(0, 255, 0), thickness=1)
    #drawRegion(frame, to_homogeneous(rect2corner(avg_corner(corners))), color=(255, 0, 0), thickness=1)
    #drawRegion(frame, to_homogeneous(rect2corner(minmax_corner(corners))), color=(255, 255, 255), thickness=1)
    #plt.imshow(frame)
    #plt.show()
    #exit()
